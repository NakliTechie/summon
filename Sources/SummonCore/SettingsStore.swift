...
public struct SettingsStore: Sendable {
    ...
    public func set(_ key: String, value: JSONValue) throws {
        try dbQueue.write { db in
            try set(key, value: value, in: db)
        }
    }

    func set(_ key: String, value: JSONValue, in db: Database) throws {
    ...
    public func delete(_ key: String) throws {
        try dbQueue.write { db in
            try delete(key, in: db)
        }
    }

    func delete(_ key: String, in db: Database) throws {
    ...
    func all(in db: Database) throws -> [String: JSONValue] {
